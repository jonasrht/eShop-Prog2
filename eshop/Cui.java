...
public class Cui {
    ...
    public void artikelMenuMitarbeiter(Mitarbeiter mitarbeiter) {
        ...
        boolean change = true;
        do {
            artikelVerwaltung.artikelAnzeigen();
            ...
            switch (input) {
                ...
                case "3":
                    ...
                    Artikel artikel2 = artikelVerwaltung.getArtikelViaID(inputArtikel);
                    System.out.println("Wie hoch soll der Bestand des Artikels sein?");
                    System.out.print("Eingabe >");
                    int inputArtikelNewBst = eingabe.nextInt();
                    artikelVerwaltung.artikelBestandAendern(artikel2, inputArtikelNewBst);
                    Log log1 = new Log(mitarbeiter, artikel2, inputArtikelNewBst);
                    log1.logRegisterEmployee(log1);
                ...
                case "4":
                    ...
                    try {
                        artikelVerwaltung.artikelNeu(inputName, inputPrs, inputBst);
                    }catch (ArtikelExistiertBereitsException e) {
                        System.out.println("Fehler bei der erstellung des Artikels");
                        e.printStackTrace();
                    }
                    Log log2 = new Log(mitarbeiter, inputName, inputBst, "neuer Artikel erstellt");
                    log2.logHinzufuegen(log2);
                ...
                case "5":
                    ...
                    try {
                        artikelVerwaltung.massenartikelNeu(massArtikelName, massenArtPreis, massenArtBst, massenArtPackungsgr);
                    }catch (ArtikelExistiertBereitsException e) {
                        System.out.println("Fehler bei der erstellung des Artikels");
                        e.printStackTrace();
                    }
        ...
        do {
            ...
            switch (input) {
                case "1":
                    ...
                    String inputArtikelStr = eingabe.nextLine();
                    int inputArtikel = Integer.parseInt(inputArtikelStr);
                    Artikel artikel = artikelVerwaltung.getArtikelViaID(inputArtikel);
    ...
    public void guthabenMenuKunde(Kunden kunde) {
        boolean menu = true;
        do {
            System.out.println("Guthaben beträgt momentan: " + kundenVerwaltung.guthabenAnzeigen(kunde));
            ...
            switch (input) {
                case "1":
                    ...
                    kundenVerwaltung.guthabenAufladen(kunde, inputGuthaben);
                    break;
                case "2":
                    menu = false;
                    break;
    ...
    public void kundeLogin() {
        ...
        try{
            Kunden kunde = kundenVerwaltung.logInCustomer(passwortInput, emailInput);
            kundenMenu(kunde);
        } catch(LoginFehlgeschlagen e){
            e.printStackTrace();
        }
//        if (kundenVerwaltung.logInCustomer(passwortInput, emailInput)) {
//            Kunden kunde = kundenVerwaltung.getCustomer(passwortInput, emailInput);
//            kundenMenu(kunde);
//        }
    }
    ...
    public void register() {
        ...
        kundenVerwaltung.registerCustomer(nameInputRegister, emailInputRegister, passwortInputRegister,
    ...
    public String passwortValidationFirst() {
        ...
        do { //Passwort 1)
            ...
            if (kundenVerwaltung.valPassword(passwortInput)) {
    ...
    public void registerMitarbeiter() {
        ...
        System.out.println("[!] Registrierung erfolgreich! Bitte loggen sie sich nochmal ein.");
        mitarbeiterVerwaltung.registerEmployee(nameInputRegister1, emailInputRegister1, passwortInputRegister1);
    }
    ...
    public void mitarbeiterLogin() {
        ...
        String passwortInput = eingabe.nextLine();
        try{
            Mitarbeiter mitarbeiter = mitarbeiterVerwaltung.logInEmployee(passwortInput, emailInput);
